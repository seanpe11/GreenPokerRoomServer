...
action = {playerIndex: 3, action:"CHECK", value:1}  // bigblind
console.log(game.playerAction(action))
console.log(game.info)

//flop
console.log("-----------------FLOP---------------")
action = {playerIndex: 2, action:"CHECK", value:1} // smallblind
console.log(game.playerAction(action))
console.log(game.info)

action = {playerIndex: 3, action:"FOLD", value:1}  // bigblind
console.log(game.playerAction(action))
console.log(game.info)
...
action = {playerIndex: 1, action:"CHECK", value:2}
console.log(game.playerAction(action))
console.log(game.info)
...
action = {playerIndex: 0, action:"RAISE", value:5} // smallblind
console.log(game.playerAction(action))
console.log(game.info)
...
//river
console.log("-----------------river---------------")
action = {playerIndex: 3, action:"RAISE", value:20} // smallblind
console.log(game.playerAction(action))
console.log(game.info)

action = {playerIndex: 0, action:"CALL", value:20} // smallblind
console.log(game.playerAction(action))
console.log(game.info)

action = {playerIndex: 1, action:"FOLD", value:5} // smallblind
console.log(game.playerAction(action))
console.log(game.info)
